...
os.makedirs('/cluster/home/guanji/Projects/semseg/dataset/scannet/list/', exist_ok=True)
with open('/cluster/home/guanji/Projects/semseg/dataset/scannet/list/training.txt', 'w') as f:
    for scan_name in train_scans_list:
        ...
        for i in trange(0, num_scans, 24):

            color_rel_name = 'scans/' + scan_name + '/data/color/' + color_img_list[i]
            label_rel_name = 'scans/' + scan_name + '/label-proc/' + label_img_list[i]
            ...
            f.write(f'{color_rel_name} {label_rel_name}\n')
